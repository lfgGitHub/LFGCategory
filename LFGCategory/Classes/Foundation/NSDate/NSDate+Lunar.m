...
NSMutableDictionary *worktime() {
    ...
    dispatch_once(&token, ^{
        _worktime = [@{
                       ...
                       @"y2018": @{@"d0101":@2,@"d0211":@1,@"d0215":@2,@"d0216":@2,@"d0217":@2,@"d0218":@2,@"d0219":@2,@"d0220":@2,@"d0221":@2,@"d0224":@1,@"d0405":@2,@"d0406":@2,@"d0407":@2,@"d0408":@1,@"d0428":@1,@"d0429":@2,@"d0430":@2,@"d0501":@2,@"d0616":@2,@"d0617":@2,@"d0618":@2,@"d0922":@2,@"d0923":@2,@"d0924":@2,@"d0929":@1,@"d0930":@1,@"d1001":@2,@"d1002":@2,@"d1003":@2,@"d1004":@2,@"d1005":@2,@"d1006":@2,@"d1007":@2}
                       } mutableCopy];
    });
    return _worktime;
}
...
- (BOOL)isNewLunarYear {
    return isNewLunarYear([self _year], [self _month], [self _day]);
}

- (BOOL)isLeapYear {
    return isLeapYear([self _year]);
}

- (NSString *)lunarYearName {
    return getLunarYearName([self _year], 0);
}

- (NSString *)yearZodiac {
    return getYearZodiac([self _year]);
}

- (NSDictionary *)calendarInfo {
    return calendar([self _year], [self _month]);
}

- (NSDictionary *)lunarInfo {
    return solarToLunar([self _year], [self _month], [self _day]);
}
