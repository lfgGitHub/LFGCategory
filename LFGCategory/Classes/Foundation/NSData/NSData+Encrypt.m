...
- (NSData *)encryptWithRSAUsingPublicKey:(NSString *)pubKey;
{
    ...
    return [self encryptData:self withKeyRef:keyRef isSign:NO];
}
...
- (NSData *)encryptWithRSAUsingPrivateKey:(NSString *)privKey;
{
    ...
    return [self encryptData:self withKeyRef:keyRef isSign:YES];
}
...
- (NSData *)decryptWithRSAUsingPublicKey:(NSString *)pubKey;
{
    ...
    return [self decryptData:self withKeyRef:keyRef];
}
